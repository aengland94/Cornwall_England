 ...
 */
public enum Boss{
    AELIUS(13,"Tall, well built man with large armour",new Weapon("SWORD", 10), new Armour()),
    ...
    FURIUS(6,"He is an angry and short man, but he is determined not to let his height stop him from trying to stop you.",new Weapon("SWORD", 35), new Armour("ARMOUR", 35)),
